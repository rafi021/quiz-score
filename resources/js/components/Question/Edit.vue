<template>
    ...
    <form @submit.prevent="updateQuestion(question)">
        <!-- Title -->
        <div>
        ...
        <div class="mt-4">
            ...
            <input type="text" id="pass-mark" v-model="question.options" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></input>
            <div class="mt-1 text-red-600">
...
const { question, getQuestion, isLoading, validationErrors, updateQuestion} = useQuestion();
